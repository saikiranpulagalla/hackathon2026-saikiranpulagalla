...
EXAMPLES = [
    ("✅ Refund (Eligible)",
     "Hi, I bought a pair of headphones last month but they stopped working after a week. Order number is ORD-1001. I'd like a full refund please.",
     "alice.turner@email.com",
     "Expected: AUTO-RESOLVE → 4 tool calls → issue_refund → send_reply"),
    ("💰 Refund (High Value >$100)",
     "Hello, I received my smart watch on March 4th (order ORD-1002) but I don't like it. Can I return it for a refund?",
    ...
    ("📦 Order Status",
     "I ordered a coffee maker over 3 days ago and haven't received it. What is going on? Order ORD-1010.",
     "james.wu@email.com",
    ...
    ("👑 VIP Complaint",
     "This is completely unacceptable! My order ORD-1005 arrived damaged for the THIRD time. I'm a premium member and I expect better service. I want a full refund AND compensation.",
     "emma.collins@email.com",
